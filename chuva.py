...
def animacao_personagem():
    ...
    if jogador_retangulo.right >= 980:
        jogador_retangulo.right  = 980
    elif jogador_retangulo.left <= 50:
        jogador_retangulo.left = 50
...
def mostra_textos():
    ...
    logo_moeda = pygame.transform.scale(moeda_superficies[0], (40, 40))
